  ...
  <div class="auth-page">
    <div class="auth-card">
      <div class="auth-header">
        ...
        <p class="subtitle">Uneix-te a la millor experiència de cinema</p>
      </div>
      ...
      <form @submit.prevent="handleRegister" class="auth-form">
        ...
        <div class="form-group-row">
          <div class="form-group">
            ...
            <p class="input-hint">Mínim 8 caràcters</p>
          </div>
          <div class="form-group">
        ...
        <button type="submit" class="btn-auth" :disabled="loading">
          {{ loading ? 'CREANT COMPTE...' : "REGISTRA'T ARA" }}
        </button>
      </form>

      <div class="auth-footer">
        <p>Ja ets dels nostres?</p>
        <NuxtLink to="/login" class="link-secondary">Inicia sessió aquí</NuxtLink>
      </div>
    </div>
